...
class QuantImpactDBAgent:
    ...
    def __init__(self, shared_clients=None):
        ...
        self.storage_agent = QuantImpactStorageAgent(shared_clients=shared_clients)
    ...
    def retrieve_datasets(self, ticker: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            result = self.storage_agent.retrieve_8_datasets_from_csv(ticker)
    ...
    def check_data_exists(self, ticker: str) -> bool:
        """
...
async def generate_quant_impact(ticker: str) -> Dict[str, Any]:
    """
    Simple function to generate and store 7 datasets (English only)
    
    Usage:
        result = await generate_quant_impact("AAPL")
    """
    from shared_clients import shared_clients
...
def retrieve_quant_impact(ticker: str) -> Dict[str, Any]:
    """
    Simple function to retrieve 7 datasets
    
    Usage:
        datasets = retrieve_quant_impact("AAPL")
    """
    from shared_clients import shared_clients

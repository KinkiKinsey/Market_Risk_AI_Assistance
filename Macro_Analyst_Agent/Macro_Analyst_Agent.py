...
class MacroAnalystAgent:
    ...
    def __init__(self, user_id: str = None, shared_clients=None, redis_host: str = None, redis_port: int = None, 
        ...
        # Frontend Redis client - fail fast if shared_clients not available
        if not shared_clients:
            raise Exception("❌ Shared clients not available - Macro_Analyst_Agent requires shared_clients")

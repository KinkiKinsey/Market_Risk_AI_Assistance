...
class MacroDBAgent:
    ...
    def __init__(self, shared_clients=None, redis_host: str = None, redis_port: int = None, 
        ...
        # Connect to Redis instances - fail fast if shared_clients not available
        if not shared_clients:
            raise Exception("❌ Shared clients not available - Macro_DB_Agent requires shared_clients")
    ...
    def check_if_update_needed(self, hours_threshold: int = 168) -> bool:  # Macro: 1 week (168 hours)
        """

...
class RedisEarningsAndFutureStorage:
    ...
    def __init__(self, shared_clients=None, host: str = None, port: int = None, username: str = "default", password: str = None, decode_responses: bool = True):
        ...
        if shared_clients:
            ...
            logging.info("✅ Using shared earnings and future Redis connection via database_connection")
        else:
            ...
            logging.info("✅ Using direct earnings and future Redis connection via database_connection")
...
class EarningsAndFutureDatabaseStorage:
    ...
    async def get_earnings_and_future_data(self, ticker: str, collection_name: str = "Earnings_and_Future_INFOS") -> Optional[Dict]:
        ...
        return await self.storage.get_earnings_and_future_data(ticker, collection_name)
    ...
    async def get_or_download_earnings_and_future(self, ticker: str, collection_name: str = "Earnings_and_Future_INFOS") -> Optional[Dict]:
        """
        Get earnings and future data from database, download if not exists or data is stale.
        Update logic: 30-day freshness threshold.
            ...
            if existing_data:
                ...
                if stored_at:
                    try:
                        ...
                        if days_since_update < 30:  # Earnings and Future: 30 days

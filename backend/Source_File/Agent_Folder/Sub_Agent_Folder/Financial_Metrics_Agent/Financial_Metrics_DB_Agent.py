...
class RedisFinancialMetricsStorage:
    ...
    def __init__(self, shared_clients=None, host: str = None, port: int = None, username: str = "default", password: str = None, decode_responses: bool = True):
        ...
        if shared_clients:
            ...
            logging.info("✅ Using shared financial metrics Redis connection via database_connection")
        else:
            ...
            logging.info("✅ Using direct financial metrics Redis connection via database_connection")
    ...
    def delete_financial_metrics_data(self, ticker: str, collection_name: str = "Financial_Metrics_INFOS") -> bool:
        """
...
class FinancialMetricsDatabaseStorage:
    ...
    async def get_or_download_financial_metrics(self, ticker: str, collection_name: str = "Financial_Metrics_INFOS") -> Optional[Dict]:
        ...
        Update logic: 15-day freshness threshold.
        ...
        try:
            ...
            if existing_data:
                ...
                if last_update:
                    try:
                        # 15-day update logic (consistent with update_pool)
                        ...
                        if days_since_update < 15:
                            ...
                            logging.info(f"✅ Data for {ticker} is fresh ({days_since_update} days old, threshold: 15 days)")
                            return existing_data
                        else:
                            # Data is stale (15+ days old) - need update
                            logging.info(f"🔄 Data for {ticker} is {days_since_update} days old (threshold: 15 days) - updating")
...
async def main():
    ...
    # Configure logging (file logging disabled)
    logging.basicConfig(

...
from config import FMP_API_KEY, DEEPSEEK_API_KEY, DEEPSEEK_BASE_URL

API_KEY = FMP_API_KEY  # Alias for backward compatibility
...
def deepseek_api_call(prompt, base_url=None, model="deepseek-chat"):
    if base_url is None:
...
def download_indicator_with_dates(indicator_name, api_key, from_date, to_date):
    ...
    url = f"{FMP_STABLE_URL}/economic-indicators"

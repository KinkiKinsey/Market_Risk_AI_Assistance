...
try:
    from config import OPENAI_API_KEY, DEEPSEEK_API_KEY, DEEPSEEK_BASE_URL, \
                       ...
                       REDIS_MAX_CONNECTIONS, HTTP_MAX_CONNECTIONS, HTTP_MAX_PER_HOST, HTTP_TIMEOUT
except ImportError:
    # No fallback - require config.py
    raise ImportError("config.py is required. Please ensure it exists in the backend directory.")

# Redis Configuration - Use centralized config
...
# Connection Pool Settings - Use centralized config
# REDIS_MAX_CONNECTIONS, HTTP_MAX_CONNECTIONS, etc. already imported from config
